...
OCTET_STRING* lpp_PLI_location_estimate(LPP_Transaction* transaction, LocationInformation* li,
                                        bool has_information);
OCTET_STRING* lpp_PLI_location_measurements(LPP_Transaction* transaction, ECIDInformation* li,
                                            bool has_information);